...
var kuhong = db.get('ojan'); // jan diubah
	...
	console.log('WELCOME TO ZESTIUM API!') // boleh diubah
}

var creatorList = ['ZestiumTeam']; // Nama Lu Ngab
var creator = creatorList[Math.floor(Math.random() * creatorList.length)]; // Ini jan diubah
var key = 'ZtmKey' // Apikey Lu Ngab
...
loghandler = {
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: `Apikey tidak ditemukan! Silahkan kontak Owner untuk dapatkan Apikey wa.me/62857066426326`
    },
    invalidLink: {
        status: false,
        creator: `${creator}`,
